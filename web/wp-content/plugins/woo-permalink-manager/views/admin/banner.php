...
<div class="notice woo-permalink-manager-banner" data-get-woo-permalink-manager-banner>
    ...
    <h1 class="woo-permalink-manager-banner--heading">
        <?php _e('Premmerce WooCommerce Product Filter Premium', 'premmerce-url-manager') ?>
    </h1>
    <p>
        <?php _e('Get clean URLs and additional Pro SEO settings for your Filter pages with Premmerce WooCommerce Filter Premium for only $69!', 'premmerce-url-manager') ?>
        <a
