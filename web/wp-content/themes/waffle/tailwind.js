      ...
      const mediaQueries = Object.keys(screens).map((key) => {
        ...
        return {
          [`@media (min-width: ${width})`]: {
            '.container': {
              'padding-left': key === 'xl' ? config('padding.1') : 0,
              'padding-right': key === 'xl' ? config('padding.1') : 0,
            },
          },
        }
      })
    ...
    function({ addComponents, config }) {
      ...
      const mediaQueries = Object.keys(screens).map((key) => {
        ...
        return {
          [`@media (min-width: ${width})`]: {
            '.container-sm': {
              'padding-left': key === 'xl' || key === 'md' || key === 'lg' ? config('padding.1') : 0,
              'padding-right': key === 'xl' || key === 'md' || key === 'lg' ? config('padding.1') : 0,
            },
          },
        }
      })
